...
void ADC_Show() {
    ...
    sprintf(String, "%.2f V", ADC1_Data_Rx[0] * 3.170 / 4095);
    ...
    sprintf(String, "%.2f V", ADC3_Data_Rx[20] * 3.170 / 4095);
    LCD_DisplayString(30, 48, 16, (u8*)String);
    sprintf(String, "%.2f V", ADC3_Data_Rx[21] * 3.170 / 4095);
...
void DAC_OUTPUT() {
    // 以下代码被禁用，但展示了示例用法：
    // DAC_Data_Tx = 1.3/3.3*4095; // 设置DAC输出电压为1.3V
