...
/****************************************************************************
* 名    称: void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2)
* 功    能：画线
* 入口参数：x1,y1:起点坐标
            x2,y2:终点坐标  
* 返回参数：无
...
/****************************************************************************
* 名    称: void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2)
* 功    能：画矩形
* 入口参数：x1,y1:对角起点坐标
            x2,y2:对角终点坐标
* 返回参数：无
...
/****************************************************************************
* 名    称: void LCD_Color_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2, u16 color)
* 功    能：在设置的坐标处画相应颜色（在该点写入自定义颜色）
* 入口参数：x1,y1:起点坐标
            x2,y2:终点坐标
            color 此点的颜色值
...
* 说    明：color:写入此点的颜色值   GUI调用该函数
****************************************************************************/
void LCD_Color_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2, u16 color)
{
	u16 t; 
	int xerr=0,yerr=0,delta_x,delta_y,distance; 
	int incx,incy,uRow,uCol; 
...
/****************************************************************************
* 名    称: void LCD_Color_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2, u16 color)
* 功    能：在设置的坐标处画相应颜色（在该点写入自定义颜色）
* 入口参数：x1,y1:对角起点坐标
            x2,y2:对角终点坐标
            color 此点的颜色值
...
* 说    明：color:写入此点的颜色值   GUI调用该函数
****************************************************************************/
void LCD_Color_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2, u16 color)
{
